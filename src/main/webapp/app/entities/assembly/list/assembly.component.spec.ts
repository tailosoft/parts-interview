...
describe('Component Tests', () => {
  describe('Assembly Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule, TranslateModule.forRoot(), RouterTestingModule.withRoutes([]), AssemblyComponent],
        providers: [
          ConfirmationService,
          MessageService,
          {
        ...
        .overrideTemplate(AssemblyComponent, '')
        .compileComponents();
      ...
      comp.assemblyTable = { filters: {}, createLazyLoadMetadata: () => undefined } as Table;
    });
    ...
    it('Should call load all on init', fakeAsync(() => {
      ...
      jest.spyOn(service, 'query').mockReturnValue(
        of(
          new HttpResponse({
            body: [{ parent: { id: 123 }, child: { id: 123 } }],
          }) as any
        )
      );
      ...
      expect(comp.assemblies?.[0]).toEqual(expect.objectContaining({ parent: { id: 123 }, child: { id: 123 } }));
    }));
