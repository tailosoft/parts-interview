package com.tailosoft.interview.parts.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.tailosoft.interview.parts.service.EmailAlreadyUsedException ||
            ex instanceof com.tailosoft.interview.parts.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.tailosoft.interview.parts.service.InvalidPasswordException
